...
public class LayeredMusic : MonoBehaviour {
    ...
    IEnumerator FadeOut(AudioSource source, float duration) {
         ...
         * We snap volume to 0 when fading out to make sure the volume is completely off afterward because a value 
         * of 0.0f is required to trigger another coroutine. We don't have to do this when fading in, as a 
